...
<body>
	<table id="dg" class="" title="列表" style="width: 700px; height: 300px">
		<thead>
			<tr>
				...
				<th data-options="field:'sn',width:100">学生学号</th>
	...
	<div id="toolbar">
		...
		<div>
			学生学号: <input class="easyui-textbox" id="paramSn">
	...
	<div id="dlg" class="easyui-dialog" title="数据参数" data-options="modal:true" style="width: 480px; height: 430px;" closed="true" buttons="#dlg-buttons">
		<form method="post" id="fm">
			<table cellpadding="5">
				...
				<tr>
	    			<td>学生学号:</td>
	    			<td><input class="easyui-textbox" id="sn" type="text" name="sn" maxlength="10" required="true" missingMessage="学号必须填写"></input></td>
	    		</tr>
	    		<tr>
	    			<td>学生姓名:</td>
	...
	function studentSearch(){
		var queryCondition = {'sn':$('#paramSn').val(),'name':$('#paramStudent').val(),'mobile': $('#paramMobile').val(),'qq': $('#paramQq').val(),'dormName': $('#paramDormName').val()};
